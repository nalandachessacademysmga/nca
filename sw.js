...
const CACHE_NAME = 'nalanda-chess-v1';
...
const urlsToCache = [
    ...
    'https://firebasestorage.googleapis.com/v0/b/nalandachessacademy-474db.firebasestorage.app/o/App_assets%2FTournament.png?alt=media&token=acc6dc17-1bbb-491e-93d7-d23c131ecfc9', // Hero image
    'https://firebasestorage.googleapis.com/v0/b/nalandachessacademy-474db.firebasestorage.app/o/App_assets%2FHeaderPic.jpg?alt=media&token=7b7464bd-9c50-43da-9907-054a5e45c659' // About Us image
];
...
self.addEventListener('fetch', (event) => {
    ...
    const isFirebaseStorageImage = event.request.url.includes('firebasestorage.googleapis.com');
    ...
    if (isFirebaseStorageImage || isKnownStaticAsset) {
        event.respondWith(
